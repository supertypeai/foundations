...
export const CAP_TRIM =
  "[text-box:trim-both_cap_alphabetic] pb-[0.35em] -mb-[0.35em]";
...
export const ON_BASELINE =
  "items-baseline [&>:is(svg,img,:empty,[class*=size-])]:self-center [&>:has(>:is(svg,img,:empty,[class*=size-]):first-child)]:self-center";
