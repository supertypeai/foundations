 ...
 * utility.
 */
const HEADING_BASE = "scroll-m-20 font-heading font-[number:var(--heading-weight)] text-foreground";
...
export function TypographyH3({ className, children, ...props }) {
    return (_jsx("h3", { className: cn(HEADING_BASE, "text-h3", className), ...props, children: children }));
}
